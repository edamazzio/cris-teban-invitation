...
export default function Portada() {
    ...
    return (
        <section className="h-[90vh] w-full flex flex-col items-center justify-center relative">
            ...
            <div className="text-center absolute top-[30%] md:top-[25%] left-1/2 -translate-x-1/2 z-10 transition-all duration-500 w-full">
                <p className={`text-2xl text-amber-50 ${im_fell.className} mb-1`}>
                    Wedding day
                </p>
                <h1 className={`text-6xl  font-bold text-amber-50 mb-4 ${italianno.className}`}>
