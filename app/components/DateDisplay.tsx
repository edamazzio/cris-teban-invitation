...
export default function DateDisplay({
    ...
    return (
        <div className="flex flex-col items-center justify-center py-7 pt-2 px-4">
            {/* Month */}
            <p className={`${im_fell.className} text-sm tracking-[0.3em] text-[#e8e4d8] mb-1`}>
                {month}
            </p>
            ...
            <div className="flex items-center gap-4">
                ...
                <p className={`${pinyonScript.className} text-5xl text-[#e8e4d8]`}>
                    {day}
                </p>
                <div className="w-24 h-[1px] bg-[#e8e4d8]"></div>
            </div>
